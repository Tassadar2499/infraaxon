...
export interface Component { id: string; environment_id: string; name: string; type: string; endpoint: string; web_url?: string; description: string; settings: Record<string, unknown>; dependencies: string[]; enabled: boolean; agent_state: string; last_seen?: string; observation?: Evidence }
